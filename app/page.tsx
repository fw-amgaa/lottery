            ...
            {[
              {
                step: "01",
                title: "Тасалбар авах",
                desc: "Төрийн банкны MN300034 889696595988 дансруу тасалбарын үнийн дүнг шилжүүлнэ үү. Гүйлгээний утганд «УТАСНЫ ДУГААР» форматаар бичнэ үү. Жишээ: 99887766",
              },
              {
                step: "02",
                title: "Хожлоо шалгах",
              ...
              <div>
                ...
                <ul className="space-y-1.5 text-sm leading-relaxed text-white/40">
                  <li>
                    ...
                    <span className="font-mono text-white/60">99887766</span>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
              ...
              <p className="text-sm leading-relaxed text-white/40">
                ...
                <span className="font-mono text-white/50">УТАСНЫ ДУГААР</span>{" "}
